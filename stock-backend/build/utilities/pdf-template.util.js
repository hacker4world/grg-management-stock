...
exports.generateFicheExpeditionHtmlForDemande = generateFicheExpeditionHtmlForDemande;
exports.generateFicheExpeditionHtmlForSortie = generateFicheExpeditionHtmlForSortie;
exports.generateBLHtmlForSortie = generateBLHtmlForSortie;
exports.generateBonDeRetourHtml = generateBonDeRetourHtml;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const company_config_1 = require("../config/company.config");
/* ------------------------------------------------------------------ */
/*  Helpers                                                            */
/* ------------------------------------------------------------------ */
...
function getLogoDataUri() {
    const conf = company_config_1.companyConfig;
    if (!conf.logoPath)
        return null;
...
/* ================================================================== */
function generateFicheExpeditionHtmlForDemande(demande) {
    const conf = company_config_1.companyConfig;
...
/* ================================================================== */
function generateFicheExpeditionHtmlForSortie(sortie) {
    const conf = company_config_1.companyConfig;
...
/* ================================================================== */
function generateBLHtmlForSortie(sortie) {
    const conf = company_config_1.companyConfig;
    const docNum = generateDocNum(sortie.id);
    const dateFr = toFrenchDate(sortie.date);
...
/* ================================================================== */
function generateBonDeRetourHtml(retour) {
    const conf = company_config_1.companyConfig;
    ...
    const clientResp = retour.chantier?.compte
        ? `Responsable: ${retour.chantier.compte.prenom} ${retour.chantier.compte.nom}`
        : "";
    /* ---- table rows ---- */
    let totalQty = 0;
...
//# sourceMappingURL=pdf-template.util.js.map