...
function translateTypeSortie(type) {
    switch (type) {
...
function buildDateWhereClause(baseWhere, dateFrom, dateTo) {
    if (dateFrom && dateTo) {
        baseWhere.date = (0, typeorm_1.Raw)((alias) => `${alias} BETWEEN :from AND :to`, {
            from: dateFrom,
            to: dateTo,
        });
    }
    else if (dateFrom) {
        baseWhere.date = (0, typeorm_1.Raw)((alias) => `${alias} >= :from`, { from: dateFrom });
    }
    else if (dateTo) {
        baseWhere.date = (0, typeorm_1.Raw)((alias) => `${alias} <= :to`, { to: dateTo });
    }
    return baseWhere;
}
/* ------------------------------------------------------------------ */
...
class ExportService {
    ...
    async sendExcelResponse(response, workbook, fileName) {
    ...
    /*  EXPORT ARTICLES                                                  */
    /* ================================================================ */
    async exportArticles(request, response) {
        try {
            ...
            if (articleList?.length > 0)
                articlesToExport = articleList;
            else {
                articlesToExport = await repositories_1.articlesRepositoy.find({
                    relations: ["depot", "unite", "categorie"],
                });
            }
            articlesToExport.forEach((article) => worksheet.addRow({
                ...article,
    ...
    /*  EXPORT FOURNISSEURS                                              */
    /* ================================================================ */
    async exportFournisseurs(request, response) {
        try {
            ...
            if (fournisseurList?.length > 0) {
                ...
                dataToExport = await repositories_1.fournisseurRepository.find();
            }
    ...
    /*  EXPORT FABRIQUANTS                                               */
    /* ================================================================ */
    async exportFabriquants(request, response) {
        try {
            ...
            if (fabriquantList?.length > 0) {
                ...
                dataToExport = await repositories_1.fabriquantRepository.find();
            }
            dataToExport.forEach((item) => worksheet.addRow(item));
    ...
    /*  EXPORT CHANTIERS                                                 */
    /* ================================================================ */
    async exportChantiers(request, response) {
        try {
            ...
            if (chantierList?.length > 0) {
                ...
                dataToExport = await repositories_1.chantierRepository.find({
                    relations: ["compte"],
                });
            }
            dataToExport.forEach((chantier) => worksheet.addRow({
                ...chantier,
    ...
    /*  EXPORT FAMILLES                                                  */
    /* ================================================================ */
    async exportFamilles(request, response) {
        try {
            ...
            if (familleList?.length > 0) {
                ...
                dataToExport = await repositories_1.familleRepository.find();
            }
            dataToExport.forEach((item) => worksheet.addRow(item));
    ...
    /* ================================================================ */
    async exportSousFamilles(request, response) {
        try {
            ...
            if (sousFamilleList?.length > 0) {
                ...
                dataToExport = await repositories_1.sousFamillesRepository.find({
                    relations: ["famille"],
                });
            }
            dataToExport.forEach((item) => worksheet.addRow({
                ...item,
    ...
    /* ================================================================ */
    async exportCategories(request, response) {
        try {
            ...
            if (categorieList?.length > 0) {
                ...
                dataToExport = await repositories_1.categoryRepository.find({
    ...
    /* ================================================================ */
    async exportEntrees(request, response) {
        try {
            ...
            if (entreeList?.length > 0) {
                ...
                dataToExport = await repositories_1.entreeRepository.find({
                    relations: [
                        "fournisseur",
                        "fabriquant",
                        "compte",
    ...
    /* ================================================================ */
    async exportSorties(request, response) {
        try {
            ...
            if (sortieList?.length > 0) {
                ...
                buildDateWhereClause(where, dateFrom, dateTo);
                dataToExport = await repositories_1.sortieRepository.find({
                    relations: [
                        "chantier",
                        "depot",
                        "compte",
    ...
    /* ================================================================ */
    async exportDemandesArticles(request, response) {
        try {
            ...
            if (demandeList?.length > 0) {
                ...
                const where = {};
                buildDateWhereClause(where, dateFrom, dateTo);
                dataToExport = await repositories_1.demandeArticlesRepository.find({
    ...
    /* ================================================================ */
    async exportRetoursArticles(request, response) {
        try {
            ...
            if (retourList?.length > 0) {
                ...
                const where = {};
                buildDateWhereClause(where, dateFrom, dateTo);
                dataToExport = await repositories_1.retourRepository.find({
                    relations: ["chantier", "items", "items.article"],
                    where,
                    order: { date: "DESC" },
                });
    ...
    /* ================================================================ */
    async exportHistoriqueChantier(request, response) {
        try {
            ...
            const buildWhere = () => {
                const w = { chantier: { code: chantierId } };
            ...
            /* ================================================================ */
            const confirmedSorties = await repositories_1.sortieRepository.find({
            ...
            const allRetours = await repositories_1.retourRepository.find({
                where: {
                    chantier: { code: chantierId },
            ...
            for (const retour of allRetours) {
                const targetMap = retour.status === "confirmed"
                    ? confirmedReturnMap
                    : pendingReturnMap;
    ...
    /* ================================================================ */
    async exportNotifications(request, response) {
        try {
            ...
            if (notificationList?.length > 0) {
                ...
                dataToExport = await repositories_1.stockNotificationRepository.find({
                    relations: ["article"],
                });
            }
            dataToExport.forEach((item) => worksheet.addRow({
    ...
    /*  EXPORT UNITES                                                    */
    /* ================================================================ */
    async exportUnites(request, response) {
        try {
            ...
            if (uniteList?.length > 0) {
                ...
                dataToExport = await repositories_1.uniteRepository.find();
            }
            dataToExport.forEach((item) => worksheet.addRow(item));
    ...
    /*  EXPORT DEPOTS                                                    */
    /* ================================================================ */
    async exportDepots(request, response) {
        try {
            ...
            if (depotList?.length > 0) {
                ...
                dataToExport = await repositories_1.depotRepository.find();
            }
            dataToExport.forEach((item) => worksheet.addRow(item));
    ...
    /*  EXPORT COMPTES                                                   */
    /* ================================================================ */
    async exportComptes(request, response) {
        try {
            ...
            if (compteList?.length > 0) {
                ...
                dataToExport = await repositories_1.compteRepository.find({
